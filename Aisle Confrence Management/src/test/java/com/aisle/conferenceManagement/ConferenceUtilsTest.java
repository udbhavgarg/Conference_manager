...
public class ConferenceUtilsTest {
	...
	public void testGetNextStartTime() {
		...
		IndividualEvent talk = new IndividualEvent("Test Talk", 20);
		...
		Assert.assertEquals(nextStartTimeManual.get(Calendar.HOUR_OF_DAY),
				nextStartTimeCalculated.get(Calendar.HOUR_OF_DAY));
